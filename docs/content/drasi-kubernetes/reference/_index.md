...
<div class="card-grid">
  ...
  <a href="ingress/">
    <div class="unified-card unified-card--reference">
      ...
      <div class="unified-card-content">
        <h3 class="unified-card-title">Ingress</h3>
        <p class="unified-card-summary">Network configuration and ingress setup</p>
      </div>
    </div>
  </a>
  ...
  <a href="troubleshooting/">
    <div class="unified-card unified-card--reference">
      <div class="unified-card-icon"><i class="fas fa-bug"></i></div>
      <div class="unified-card-content">
        <h3 class="unified-card-title">Troubleshooting</h3>
        <p class="unified-card-summary">Common issues and solutions</p>
      </div>
    </div>
  </a>
</div>
