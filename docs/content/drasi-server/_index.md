...
<div class="hero-section">
  ...
  <p class="hero-subtitle">Drasi Server is a lightweight, single-container deployment that provides the full power of Drasi's change detection. Perfect for local development, Docker environments, and simpler deployments.</p>
