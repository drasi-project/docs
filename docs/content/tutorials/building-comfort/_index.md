...
Check the logs of pods created for the services `building-signalr-hub-gateway`.
  ...
  created for source which will have names like
  `building-facilities-reactivator-xxxxx` or
  `building-facilities-proxy-xxxxx`.
...
VS Code will automatically forward port 8080 to localhost.
  ...
  `http://localhost:8080.app.github.dev/hub` in your browser and see
