...
- In an e-commerce system:
  ...
  - Once the Order is delivered, it is complete.
...
In addition, using the SignalR Reaction, the Curbside Pickup and Building Comfort sample applications drive their entire React UI by effectively binding the UI to Continuous Queries.
